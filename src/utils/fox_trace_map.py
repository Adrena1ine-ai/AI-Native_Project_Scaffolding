...
from .heavy_mover import MovedFile
from .token_scanner import FileCategory
...
def write_fox_trace_md(
    ...
    > Generated by AI Toolkit Deep Clean.
    ...
    **Used in:**
    ...
    lines.append(f"> Generated by AI Toolkit Deep Clean at {trace_map.generated_at}")
    lines.append(">")
    ...
    lines.append("---")
    lines.append("")
    lines.append(f"*Generated by AI Toolkit v3.4 — Fox Trace Map*")
